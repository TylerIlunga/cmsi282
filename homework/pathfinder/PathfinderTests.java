...
public class PathfinderTests {
    ...
    public void testPathfinder_t4() {
        String[] maze = { "XXXXXXX", "X.GI..X", "X...KGX", "XXXXXXX" };
        MazeProblem prob = new MazeProblem(maze);
        ArrayList<String> solution = Pathfinder.solve(prob);
    ...
    public void testPathfinder_t5() {
        String[] maze = { "XXXXXXX", "X..IX.X", "X..KXGX", "X...X.X", "XG....X", "XXXXXXX" };
        MazeProblem prob = new MazeProblem(maze);
        ArrayList<String> solution = Pathfinder.solve(prob);
    ...
    public void testPathfinder_t6() {
        String[] maze = { "XXXXXXX", "X..IX.X", "X..KXGX", "XMM.X.X", "XGM...X", "XXXXXXX" };
        MazeProblem prob = new MazeProblem(maze);
        ArrayList<String> solution = Pathfinder.solve(prob);
    ...
    public void testPathfinder_t7() {
        String[] maze = { "XXXXXXX", "X..IXKX", "X...XMX", "XXX.XGX", "XGX...X", "XXXXXXX" };
        MazeProblem prob = new MazeProblem(maze);
        ArrayList<String> solution = Pathfinder.solve(prob);
    ...
    public void testPathfinder_nosoln_t1() {
        String[] maze = { "XXXXXXX", "XI....X", "X.M.MGX", "X.X.X.X", "XXXXXXX" };
        MazeProblem prob = new MazeProblem(maze);
        ArrayList<String> solution = Pathfinder.solve(prob);
    ...
    public void testPathfinder_nosoln_t2() {
        String[] maze = { "XXXXXXX", "XI...KX", "X.M.MXX", "X.X.XGX", "XXXXXXX" };
        MazeProblem prob = new MazeProblem(maze);
        ArrayList<String> solution = Pathfinder.solve(prob);
    ...
    public void testPathfinder_nosoln_t3() {
        String[] maze = { "XXXXXXX", "XI..XKX", "X.M.X.X", "X.X.XGX", "XXXXXXX" };
        MazeProblem prob = new MazeProblem(maze);
        ArrayList<String> solution = Pathfinder.solve(prob);
    ...
    public void testPathfinder_nosoln_t5() {
        String[] maze = { "XXXXXXX", "XIXGXKX", "XXXXXXX" };
        MazeProblem prob = new MazeProblem(maze);
        ArrayList<String> solution = Pathfinder.solve(prob);
